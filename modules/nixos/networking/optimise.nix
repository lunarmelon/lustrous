...
let
  ...
  cfg = config.moon.system.networking;
in
{
  options.moon.system.networking.optimizeTcp = mkEnableOption "Enable tcp optimizations" // {
    default = !config.moon.profiles.server.enable;
  };
